                        ...
                        <div class="tab-content" style="font-size: 12px;">
                            ...
                            <div id="icg" class=" row tab-pane">
                                ...
                                <div class=" col-md-6"  id="div_icg">
                                    ...
                                    <br>
                                    <img  style="margin: auto" src="<?php echo e(asset('img/icg.png')); ?>" alt="">
                                </div>
                            ...
                            <ul >
                                <li class="jstree-open" >TDPS
                                    ...
                                    <ul>
                                        ...
                                        <?php echo e($bolivia->nombre); ?>  / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($bolivia->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                        </li>
                                        <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' label="<?php echo e($peru->archivo); ?>">
                                          <?php echo e($peru->nombre); ?>    / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($peru->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                        </li>
                                        <?php $__currentLoopData = $tdps->where('tipo','tdps'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $td): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            ...
                                            <li  data-jstree='{ "enabled" : true,"icon":"fa fa-globe"}' tipo="tdps"  label="<?php echo e($td->archivo); ?>">
                                                <span style=" font-size:0.8em;letter-spacing:-0.4px"><?php echo e($td->nombre); ?> </span>  / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($td->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                ...
                                                <ul>
                                                    <?php $__currentLoopData = $zh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moni): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        ...
                                                        <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' tipo="pm" label="<?php echo e($moni->archivo_remas); ?>" >
                                                              <?php echo e($moni->nombre); ?>   / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($moni->archivo_remas); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                            <ul>
                                                                <?php $__currentLoopData = $moni->puntos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $punto): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                    <li data-jstree='{ "icon":"fa fa-globe"}' tipo="nn" label="<?php echo e($punto->archivo); ?>">
                                                                       <?php echo e($punto->nombre); ?>  / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($punto->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                                    </li>
                                                        ...
                                                        <?php if($td->id==20): ?>
                                                                ...
                                                                <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' tipo="pm" label="<?php echo e($moni->archivo_remfc); ?>" >
                                                                 <?php echo e($moni->nombre); ?>  / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($moni->archivo_remfc); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                                    <ul>
                                                                        <?php $__currentLoopData = $moni->puntos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $punto): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                            <li data-jstree='{ "icon":"fa fa-globe"}' tipo="nn" label="<?php echo e($punto->archivo); ?>">
                                                                               <?php echo e($punto->nombre); ?>   / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($punto->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                        ...
                                                        <?php if($td->id==21): ?>
                                                                ...
                                                                <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' tipo="pm" label="<?php echo e($moni->archivo_remli); ?>" >
                                                                  <?php echo e($moni->nombre); ?>   / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($moni->archivo_remli); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                                    <ul>
                                                                        <?php $__currentLoopData = $moni->puntos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $punto): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                            <li data-jstree='{ "icon":"fa fa-globe"}' tipo="nn" label="<?php echo e($punto->archivo); ?>">
                                                                                <?php echo e($punto->nombre); ?>   / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($punto->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                ...
                                <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}'  tipo="tdps" label="<?php echo e($poopo->archivo); ?>" >
                                   <?php echo e($poopo->nombre); ?> / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($poopo->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                    <ul>
                                        <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' tipo="pm" label="<?php echo e($sub_poopo->archivo); ?>">
                                           <?php echo e($sub_poopo->nombre); ?>  / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($sub_poopo->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                          ...
                                          Escala 1:50000
                                            <ul>
                                                <?php $__currentLoopData = $sub_poopo_5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    ...
                                                    <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' tipo="tdps" label="<?php echo e($sub->archivo); ?>">
                                                        <?php echo e($sub->nombre); ?>   / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($sub->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                        <ul>
                                                            <?php $__currentLoopData = $sub->puntos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $punto): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}'  tipo="pm" label="<?php echo e($punto->archivo); ?>">
                                                                    <?php echo e($punto->nombre); ?>   / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($punto->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                                </li>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                        </ul>
                                ...
                                <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' tipo="pm" label="<?php echo e($coipasa->archivo); ?>">
                                     <?php echo e($coipasa->nombre); ?>  / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($coipasa->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                        <ul>

                                               <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' tipo="pm" label="<?php echo e($sub_coi->archivo); ?>">
                                                <?php echo e($sub_coi->nombre); ?>  / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($sub_coi->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                               </li>
                                                 <li>
                                                     Escala 1:50000
                                                           <ul>
                                                             <?php $__currentLoopData = $sub_coipasa_5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                  ...
                                                                  <li data-jstree='{ "icon":"fa fa-globe"}' tipo="pm" label="<?php echo e($sub->archivo); ?>">
                                                                    <?php echo e($sub->nombre); ?> / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($sub->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>                                                                         <ul>
                                                                          <?php $__currentLoopData = $sub->puntos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $punto): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                            <li data-jstree='{ "opened" : true ,"icon":"fa fa-globe"}' tipo="pm" label="<?php echo e($punto->archivo); ?>">
                                                                              <?php echo e($punto->nombre); ?>   / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($punto->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                                                               </li>
                                    ...
                                    <ul>
                                        <?php $__currentLoopData = $sub_coipasa_1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $punto1): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <li data-jstree='{"icon":"fa fa-globe"}' label="<?php echo e($punto1->archivo); ?>">
                                               <?php echo e($punto1->nombre); ?> / <span><a  href="" onclick="javascript:location.href='<?php echo e(url('descargar')); ?>/<?php echo e($punto1->archivo); ?>'" title="descargar mapa" style="font-size: 10px;"class="text-sm text-warning"><i  style="color:#FFF;"class="fa fa-download "></i> </a> </span>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
