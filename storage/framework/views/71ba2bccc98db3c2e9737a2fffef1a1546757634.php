                            ...
                            <?php $__currentLoopData = $remas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td class="col-md-4">
                                        ...
                                        <a href="<?php echo e(url('admin/campanias_remli')); ?>/<?php echo e($r->id); ?>" class="btn btn-primary btn-sm"><i class="fa fa-rebel"></i></a>
                                        <a href="<?php echo e(url('admin/createmedicion_remli')); ?>/<?php echo e($r->id); ?>" class="btn btn-success btn-sm"><i class="fa fa-save"></i></a>
