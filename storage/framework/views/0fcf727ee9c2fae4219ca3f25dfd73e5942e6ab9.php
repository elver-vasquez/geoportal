        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center"><strong>MAPAS ZONAS HIDROLOGICAS  - <?php if(isset($monitoreo->codigo)): ?><?php echo e($monitoreo->codigo); ?> / <?php endif; ?> <?php echo e($monitoreo->nombre); ?></strong></h4>
                    <a href="<?php echo e(url('/admin/zonashidrologicas')); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Regresar a zonas hidrologicas</a>
