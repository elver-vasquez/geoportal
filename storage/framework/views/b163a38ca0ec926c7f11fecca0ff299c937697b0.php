                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="gases<?php echo e($m->id); ?>" class="tab-pane">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion<?php echo e($m->id); ?>" name="od_satu" id="od_satu" value="<?php echo e($m->od_satu); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion<?php echo e($m->id); ?>" name="saturacion" id="saturacion" value="<?php echo e($m->saturacion); ?>" readonly>
                                                </div>
                                            </div>
