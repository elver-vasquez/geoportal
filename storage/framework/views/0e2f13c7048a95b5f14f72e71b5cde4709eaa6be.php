                    ...
                    <div id="myModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/tdps/store')); ?>" method="post" id="form">
                                    <?php echo csrf_field(); ?>
                    ...
                    <?php if(count($tdps)>0): ?>
                        <table class="table">
                            ...
                            <tr>
                               ...
                               <td><a href="<?php echo e(url('admin/tdps/download')); ?>"><?php echo e($row->archivo); ?></a></td>
                               <td><?php echo e($row->descripcion); ?></td>
                                <td>
                                    <?php if($row->tipo=='tdps'): ?>
                                    <a href="<?php echo e(url('admin/zonashidrologicas')); ?>" class="btn btn-sm btn-primary"><i class="fa fa-arrows"></i>Zonas hidrologicas</a>
                                        <?php endif; ?>
                            ...
                            <div id="modalEdit<?php echo e($row->id); ?>" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/tdps/update')); ?>" method="post" id="form">
                                            <?php echo csrf_field(); ?>
