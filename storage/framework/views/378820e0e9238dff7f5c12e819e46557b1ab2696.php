        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="<?php echo e(url('/admin/cuencas')); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Regresar a Cuenca Poopo</a>
                    ...
                    <div id="myModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/cuencapoopo/escala1000000/store')); ?>" method="post" id="form">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php $__currentLoopData = $subcuencas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(url('admin/cuencapoopo/escala1000000/destroy')); ?>/<?php echo e($row->id); ?>" class="btn btn-sm btn-danger"><i class="fa fa-pencil"></i> Eliminar</a>
                                    </td>
                                </tr>
                                <div id="modalEdit<?php echo e($row->id); ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/cuencapoopo/escala1000000/update')); ?>" method="post" id="form">
                                                <?php echo csrf_field(); ?>
