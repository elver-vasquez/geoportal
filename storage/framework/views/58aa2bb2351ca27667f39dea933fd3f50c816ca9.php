        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center"><strong>SUBCUENCAS COIPASA  ESCALA 1:50000</strong>


                    </h4>
                    <a href="<?php echo e(url('/admin/cuencacoipasa')); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Regresar a Cuenca Coipasa</a>
                    ...
                    <div id="myModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/cuencacoipasa/storesubcuencas')); ?>" method="post" id="form">
                                    <?php echo csrf_field(); ?>
                        ...
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $subcuencas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a  title="Ver mapas" href="<?php echo e(url('admin/cuencacoipasa/mapas50000')); ?>/<?php echo e($row->id); ?>" class="btn btn-sm btn-primary"><i class="fa fa-map-marker"></i> Ver Mapas</a>
