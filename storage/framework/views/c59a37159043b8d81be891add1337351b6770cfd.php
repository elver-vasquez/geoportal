                    ...
                    <div class="panel-body">
                        ...
                        <table class=" table-striped" id="table">
                          ...
                          <?php $__currentLoopData = $remas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                              <tr>
                                  <td  class=" text-primary"  style="font-size:9px;"><strong><?php echo e($r->codigo); ?></strong></td>
                                  ...
                                  <td class="col-md-6"><?php echo e($r->estacion); ?></td>
                                  <td>
                                      <a href="<?php echo e(url('admin/createmedicion')); ?>/<?php echo e($r->id); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>

                                  </td>
                                  <td >
                                      <a href="<?php echo e(url('admin/campaniasrema')); ?>/<?php echo e($r->id); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                  </td>
                              </tr>
