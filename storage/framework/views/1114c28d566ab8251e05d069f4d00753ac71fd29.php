<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="panel panel-default">
            ...
            <form  method="post" action="<?php echo e(url('admin/medicionstore')); ?>" class="form form-horizontal ">
                <?php echo csrf_field(); ?>
                ...
                <div class="panel-footer">
                    <div >
                        <input type="hidden" name="id_remas" value="<?php echo e($rema->id); ?>" >
                        <button type="submit" class=" btn btn-success btn-lg">Guardar</button>
                        <a href="<?php echo e(url('admin/remas')); ?>" type="button" id="" class="cancelar btn btn-default btn-lg">Cancelar</a>
