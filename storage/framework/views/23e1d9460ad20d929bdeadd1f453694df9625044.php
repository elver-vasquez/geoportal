                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="recent<?php echo e($m->id); ?>" class="tab-pane ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" step="0.001" class="form-control medicion<?php echo e($m->id); ?>" name="disco" id="disco" value="<?php echo e($m->disco); ?>" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div id="gases<?php echo e($m->id); ?>" class="tab-pane">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" step="0.001" class="form-control medicion<?php echo e($m->id); ?>" name="od_satu" id="od_satu" value="<?php echo e($m->od_satu); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" step="0.001" class="form-control medicion<?php echo e($m->id); ?>" name="satu" id="satu" value="<?php echo e($m->satu); ?>" readonly>
                                                </div>
                                            </div>
