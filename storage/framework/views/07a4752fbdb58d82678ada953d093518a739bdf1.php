        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center"><strong>CUENCA POOPO</strong>

                    </h4>
                    <a href="<?php echo e(url('admin/cuencapoopo/escala50000')); ?>"  class="btn  btn-primary">Mapas escala 1:50000</a>
                    <a href="<?php echo e(url('admin/cuencapoopo/escala1000000')); ?>"  class="btn  btn-success">Mapas escala 1:1000000</a>
                    <div id="myModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/cuencas/store')); ?>" method="post" id="form">
                                    <?php echo csrf_field(); ?>
                ...
                <div class="panel-body">
                    ...
                    <?php if(count($tdps)>0): ?>
                        <table class="table">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $tdps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                ...
                                <div id="modalEdit<?php echo e($row->id); ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/cuencapoopo/updateMapa')); ?>" method="post" id="form">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="" class="control-label col-md-4">Descripcion</label>
                                                        <div class="col-md-6">
                                                            <textarea name="descripcion" id="descripcion"  class="form-control" cols="5" rows="5"><?php echo e($row->descripcion); ?></textarea>
                                                        </div>
                                                    </div>
