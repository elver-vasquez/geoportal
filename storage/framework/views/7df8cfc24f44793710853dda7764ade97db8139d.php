        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center"><strong>Sub Cuencas - <?php echo e($tdps->nombre); ?></strong>


                    </h4>
                    <a href="<?php echo e(url('/admin/cuencas')); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Regresar a Cuencas</a>
                        ...
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $subcuencas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a  title="Ver mapas" href="<?php echo e(url('admin/subcuencas/mapas_subcuencas')); ?>/<?php echo e($row->id); ?>" class="btn btn-sm btn-primary"><i class="fa fa-map-marker"></i> Ver Mapas</a>

                                    </td>
                                    <td>
                                        <a href="#modalEdit<?php echo e($row->id); ?>" data-toggle="modal" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i> Editar</a>

                                        <a href="<?php echo e(url('admin/subcuencas/destroy')); ?>/<?php echo e($row->id); ?>" class="btn btn-sm btn-danger"><i class="fa fa-pencil"></i> Eliminar</a>
                                    </td>
                                </tr>
                                <div id="modalEdit<?php echo e($row->id); ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/subcuencas/update')); ?>" method="post" id="form">
                                                <?php echo csrf_field(); ?>
