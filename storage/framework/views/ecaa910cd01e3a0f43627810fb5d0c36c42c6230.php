                    ...
                    <div id="myModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form  enctype="multipart/form-data" class="form-horizontal" action="<?php echo e(url('admin/cuencapoopo/storesubcuencas')); ?>" method="post" id="form">
                                    <?php echo csrf_field(); ?>
                        ...
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $subcuencas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a  title="Ver mapas" href="<?php echo e(url('admin/cuencapoopo/mapas50000')); ?>/<?php echo e($row->id); ?>" class="btn btn-sm btn-primary"><i class="fa fa-map-marker"></i> Ver Mapas</a>
