...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <a href="{{url('admin/createmedicion_remfc')}}/{{$rema_id}}" class="btn btn-success btn-lg">Registrar Nueva Medicion Remfc</a>
            ...
            @if($mediciones->count()>0)
                ...
                @foreach($mediciones as $m)
                    <div class="panel panel-default">
                        ...
                        <form  method="post" action="{{url('admin/medicionupdate_remfc')}}" class="form form-horizontal ">
                            {!! csrf_field() !!}
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="recent{{$m->id}}" class="tab-pane ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="ce" id="ce" value="{{$m->ce}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="temperatura" id="temperatura" value="{{$m->temperatura}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="aceites" id="aceites" value="{{$m->aceites}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="turbiedad" id="turbiedad" value="{{$m->turbiedad}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="sdt" id="sdt" value="{{$m->sdt}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="sst" id="sst" value="{{$m->sst}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="color" id="color" value="{{$m->color}}" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div id="gases{{$m->id}}" class="tab-pane">
                                            ...
                                            {{--<div class="form-group ">--}}
                                                ...
                                                {{--<div class="col-md-2">--}}
                                                    {{--<input type="number" class="form-control medicion{{$m->id}}" name="co" id="co" value="{{$m->co}}" readonly>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="od" id="od" value="{{$m->od}}" readonly>
                                                </div>
                                            </div>
                                            {{--<div class="form-group ">--}}
                                                ...
                                                {{--<div class="col-md-2">--}}
                                                    {{--<input type="number" class="form-control medicion{{$m->id}}" name="od_satu" id="od_satu" value="{{$m->od_satu}}" readonly>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                            {{--<div class="form-group ">--}}
                                                ...
                                                {{--<div class="col-md-2">--}}
                                                    {{--<input type="number" class="form-control medicion{{$m->id}}" name="saturacion" id="saturacion" value="{{$m->saturacion}}" readonly>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="number" class="form-control medicion{{$m->id}}" name="hs" id="hs" value="{{$m->hs}}" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div id="quimicos{{$m->id}}" class="tab-pane">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="ca" id="ca" value="{{$m->ca}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="mg" id="mg" value="{{$m->mg}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="na" id="na" value="{{$m->na}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="k" id="k" value="{{$m->k}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="na_k" id="na_k" value="{{$m->na_k}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                ...
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="co2" id="co2" value="{{$m->co2}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                            ...
                                            {{--<div class="col-md-6">--}}
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-5">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="co2h" id="co2h" value="{{$m->co2h}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                {{--<div class="form-group ">--}}
                                                    {{--<label for=""class="col-md-3 control-label">Cl (mg/l):</label>--}}
                                                    {{--<div class="col-md-5">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="ci" id="ci" value="{{$m->ci}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                {{--<div class="form-group ">--}}
                                                    {{--<label for=""class="col-md-3 control-label">(SO4)2- (mg/l):</label>--}}
                                                    {{--<div class="col-md-5">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="so4" id="so4" value="{{$m->so4}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                {{--<div class="form-group ">--}}
                                                    {{--<label for=""class="col-md-3 control-label">Alcalinidad (mg/l) CaCO3:</label>--}}
                                                    {{--<div class="col-md-5">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="alcalinidad" id="alcalinidad" value="{{$m->alcalinidad}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                {{--<div class="form-group ">--}}
                                                    {{--<label for=""class="col-md-3 control-label">Dureza total (mg/l) CaCO3:</label>--}}
                                                    {{--<div class="col-md-5">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="dureza" id="dureza" value="{{$m->dureza}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                        ...
                                        <div id="nutrientes{{$m->id}}" class="tab-pane">
                                            ...
                                            <div class="col-md-4">
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="sio3" id="sio3" value="{{$m->sio3}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                ...
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="nno3" id="nno3" value="{{$m->nno3}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                ...
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="nno2" id="nno2" value="{{$m->nno2}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                ...
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="nnh4" id="nnh4" value="{{$m->nnh4}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                <div class="form-group ">
                                                    <label for=""class="col-md-6 control-label">Fosfato total (mg/l):</label>
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="p" id="p" value="{{$m->p}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for=""class="col-md-6 control-label">Nitrogeno total (mg/l):</label>
                                                    <div class="col-md-6">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="nt" id="nt" value="{{$m->nt}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="b" id="b" value="{{$m->b}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="kjendall" id="kjendall" value="{{$m->kjendall}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                            ...
                                            <div class="col-md-6">
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-5">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="po4" id="po4" value="{{$m->po4}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                ...
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-5">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="pt" id="pt" value="{{$m->pt}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                {{--<div class="form-group ">--}}
                                                    {{--<label for=""class="col-md-3 control-label">Si (mg/l):</label>--}}
                                                    {{--<div class="col-md-5">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="si" id="si" value="{{$m->si}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                        ...
                                        <div id="sanitarios{{$m->id}}" class="tab-pane">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="dbo5" id="dbo5" value="{{$m->dbo5}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="dqo" id="dqo" value="{{$m->dqo}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="coli_feca" id="coli_feca" value="{{$m->coli_feca}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="coli_tot" id="coli_tot" value="{{$m->coli_tot}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                {{--<div class="form-group ">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--<input type="number" class="form-control medicion{{$m->id}}" name="salmonella" id="salmonella" value="{{$m->salmonella}}" readonly>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                <div class="form-group ">
                                                    <label for=""class="col-md-5 control-label">Bacterias colif. termorresistentes UFC/100 ml:</label>
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="bact_coli" id="bact_coli" value="{{$m->bact_coli}}" readonly>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="metales{{$m->id}}" class="tab-pane">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    <label for=""class="col-md-5 control-label">Zinc plagicidas (mg/l):</label>
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="zn" id="zn" value="{{$m->zn}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="cd" id="cd" value="{{$m->cd}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="pb" id="pb" value="{{$m->pb}}" readonly>
                                                    </div>
                                                </div>

                                                <div class="form-group ">
                                                    <label for=""class="col-md-5 control-label">Hierro soluble (mg/l):</label>
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="fe" id="fe" value="{{$m->fe}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="mn" id="mn" value="{{$m->mn}}" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="cu" id="cu" value="{{$m->cu}}" readonly>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="hg" id="hg" value="{{$m->hg}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for=""class="col-md-3 control-label">Arsenico total (mg/l):</label>
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="as" id="as" value="{{$m->as}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for=""class="col-md-3 control-label">Cromo hexavalente (mg/l):</label>
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="cr" id="cr" value="{{$m->cr}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for=""class="col-md-3 control-label">Niquel (mg/l):</label>
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="ni" id="ni" value="{{$m->ni}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for=""class="col-md-3 control-label">Antimonio (mg/l):</label>
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="sb" id="sb" value="{{$m->sb}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for=""class="col-md-3 control-label">Selenio(mg/l):</label>
                                                    <div class="col-md-5">
                                                        <input type="number" class="form-control medicion{{$m->id}}" name="se" id="se" value="{{$m->se}}" readonly>
                                                    </div>
                                                </div>
                            ...
                            <div class="panel-footer">
                                <div class="botones{{$m->id}}" style="display:none">
                                    ...
                                    <input type="hidden" name="remfc_id" value="{{$m->id_remfc}}">
