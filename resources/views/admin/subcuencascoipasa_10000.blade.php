            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center"><strong>CUENCA COIPASA ESCALA 1:1000000 </strong>
                        ...
                        <a href="{{url('/admin/cuencas')}}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Regresar a Cuenca Coipasa</a>
                    ...
                    <div id="myModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form  enctype="multipart/form-data" class="form-horizontal" action="{{url('admin/cuencacoipasa/escala1000000/store')}}" method="post" id="form">
                                    {!! csrf_field() !!}
                            ...
                            @foreach($subcuencas as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('admin/cuencacoipasa/escala1000000/destroy')}}/{{$row->id}}" class="btn btn-sm btn-danger"><i class="fa fa-pencil"></i> Eliminar</a>
                                    </td>
                                </tr>
                                <div id="modalEdit{{$row->id}}" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form  enctype="multipart/form-data" class="form-horizontal" action="{{url('admin/cuencacoipasa/escala1000000/update')}}" method="post" id="form">
                                                {!! csrf_field() !!}
