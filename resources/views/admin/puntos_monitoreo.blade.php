        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center"><strong>PUNTOS DE MONITOREO - {{$tdps->nombre}}</strong>
                ...
                <div class="panel-body">
                    ...
                    @if(count($tdps->puntos_monitoreo)>0)
                        <table class="table">
                            <thead>
                            <tr>
                                <th>Codigo</th>
                            ...
                            <tbody>
                            @foreach($tdps->puntos_monitoreo as $row)
                                <tr>
                                    <td>{{$row->codigo}}</td>
                                    <td>{{$row->nombre}}</td>
                                ...
                                <div id="modalEdit{{$row->id}}" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form  enctype="multipart/form-data" class="form-horizontal" action="{{url('admin/monitoreo/update')}}" method="post" id="form">
                                                {!! csrf_field() !!}
