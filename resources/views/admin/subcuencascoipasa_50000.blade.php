        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="{{url('/admin/cuencacoipasa')}}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Regresar a Cuenca Coipasa</a>
                    ...
                    <div id="myModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form  enctype="multipart/form-data" class="form-horizontal" action="{{url('admin/cuencacoipasa/storesubcuencas')}}" method="post" id="form">
                                    {!! csrf_field() !!}
                        ...
                        <table class="table">
                            ...
                            @foreach($subcuencas as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a  title="Ver mapas" href="{{url('admin/cuencacoipasa/mapas50000')}}/{{$row->id}}" class="btn btn-sm btn-primary"><i class="fa fa-map-marker"></i> Ver Mapas</a>
