        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center"><strong>MAPAS ZONAS HIDROLOGICAS  - @if(isset($monitoreo->codigo)){{$monitoreo->codigo}} / @endif {{$monitoreo->nombre}}</strong></h4>
                    <a href="{{url('/admin/zonashidrologicas')}}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Regresar a zonas hidrologicas</a>
                                ...
                                <div id="modalEdit{{$row->id}}" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form  enctype="multipart/form-data" class="form-horizontal" action="{{url('admin/mapaspuntos/update')}}" method="post" id="form">
                                                {!! csrf_field() !!}
