        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="{{url('admin/cuencapoopo/escala50000')}}"  class="btn  btn-primary">Mapas escala 1:50000</a>
                    <a href="{{url('admin/cuencapoopo/escala1000000')}}"  class="btn  btn-success">Mapas escala 1:1000000</a>
